...
data_file2 = "/home/qinghai/kepler/0303/x_0314_testing_new_2.txt"
data_file3 = "/home/qinghai/kepler/0303/y_0303_training.csv"
data_file4 = "/home/qinghai/kepler/0303/y_0303_testing.csv"
...
model.add(Convolution1D(nb_filter=128,
                        ...
                        activation='relu'))
model.add(MaxPooling1D(pool_length=2))
#Adding one neural demse layer
#model.add(Dense(16))
#model.add(Activation('relu'))
# Adding GRU layer 
model.add(GRU(output_dim=128))
model.add(Activation('relu'))
#two FC layers
model.add(Dense(128))
model.add(Activation('relu'))
